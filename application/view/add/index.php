...
<h1>Add People</h1>
        ...
        <div>
            <p>Add people as students or teachers.<br></p>
        </div>
        <div class="login-box" style="width: 50%; display: block;">
            <h2>Register a new account</h2>

            <!-- register form -->
            <form method="post" action="<?php echo Config::get('URL'); ?>register/register_action_inside">
                ...
                <input type="password" name="user_password_repeat" pattern=".{6,}" required placeholder="Repeat your password" autocomplete="off" />
                  <h4>Select Role:</h4>
                <input type="radio" name="role" value=1 checked="checked"> Student
                <input type="radio" name="role" value=7> Teacher<br><br>
